...
// import Aurora from "../components/ui/Aurora"; // 1. Commented out the Aurora import
...
const LandingPage = () => {
  ...
  return (
    <LenisWrapper>
      {/* 3. The main container is reverted to its original state, without the `relative` class. */}
      <div className="bg-background text-foreground">
        {/* 2. The Aurora component is now commented out. */}
        {/* <Aurora className="fixed inset-0 z-0 opacity-20" /> */}

        {/* 3. The `relative z-10` wrapper has been removed to restore the original layout. */}
