...
import Aurora from "../components/ui/Aurora"; // Assuming you place Aurora in `components/ui`
import CircularGallery from "../components/ui/CircularGallery"; // Assuming you place CircularGallery in `components/ui`
  ...
  return (
    <LenisWrapper>
      {/* 
        ...
        - `bg-background` provides a fallback color.
      */}
      <div className="relative bg-background text-foreground">
        {/* 
          The Aurora is now a fixed, full-page background.
          - `fixed inset-0` makes it cover the viewport and not scroll.
          - `z-0` places it at the bottom of the stacking context.
          - `opacity-20` makes it a subtle effect.
        */}
        <Aurora className="fixed inset-0 z-0 opacity-20" />

        {/* 
          This wrapper lifts all page content above the Aurora background.
          - `relative z-10` ensures it's on a higher layer.
        */}
        <div className="relative z-10">
          <main className="flex-grow">
            {/* Hero Section (no longer needs relative/z-index) */}
